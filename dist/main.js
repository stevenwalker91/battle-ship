...
/* harmony export */   "orchestrateAttack": () => (/* binding */ orchestrateAttack),
/* harmony export */   "orchestrateRestartGame": () => (/* binding */ orchestrateRestartGame),
/* harmony export */   "orchestrateStartGame": () => (/* binding */ orchestrateStartGame)
/* harmony export */ });
/* harmony import */ var _dom_display_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dom/display.js */ "./src/dom/display.js");
...
let playGame;
let activePlayer;
const orchestrateStartGame = function () {
  let restart = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
  if (!restart) {
    _dom_display_js__WEBPACK_IMPORTED_MODULE_0__.hideStartScreen();
    _dom_display_js__WEBPACK_IMPORTED_MODULE_0__.displayGameBoards();
  }
  const playerName = _dom_display_js__WEBPACK_IMPORTED_MODULE_0__.getPlayerName();
  _dom_display_js__WEBPACK_IMPORTED_MODULE_0__.addPlayerNameToUi(playerName);
  playGame = (0,_factories_game__WEBPACK_IMPORTED_MODULE_1__.Game)(playerName);
  _dom_display_js__WEBPACK_IMPORTED_MODULE_0__.renderShips(playGame.playerBoard.getBoatPositions(), 'enemy');
};
const orchestrateAttack = event => {
  ...
  const makeAttack = () => {
    ...
    if (activePlayer === playGame.playerOne) {
      ...
      domBoard = 'player';
      _dom_display_js__WEBPACK_IMPORTED_MODULE_0__.removeFieldFromPlay(attackPoint);
    ...
    _dom_display_js__WEBPACK_IMPORTED_MODULE_0__.renderAttack(attack.coord, attack.status, domBoard);
    _dom_display_js__WEBPACK_IMPORTED_MODULE_0__.printMoveToUi(messageToPrint, domBoard);
...
const orchestrateRestartGame = () => {
  _dom_display_js__WEBPACK_IMPORTED_MODULE_0__.resetGameBoard();
  _dom_display_js__WEBPACK_IMPORTED_MODULE_0__.toggleModal();
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "addPlayerNameToUi": () => (/* binding */ addPlayerNameToUi),
/* harmony export */   "addWinnerToModal": () => (/* binding */ addWinnerToModal),
...
/* harmony export */   "printMoveToUi": () => (/* binding */ printMoveToUi),
/* harmony export */   "removeFieldFromPlay": () => (/* binding */ removeFieldFromPlay),
...
/* harmony import */ var _listeners_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./listeners.js */ "./src/dom/listeners.js");
...
const removeFieldFromPlay = coords => {
  ...
  element.removeEventListener('click', _listeners_js__WEBPACK_IMPORTED_MODULE_1__.attackFunction);
};
...
const resetGameBoard = () => {
  ...
  gamePieces.forEach(piece => {
    ...
    if (piece.parentElement.id === 'enemy-board' && !piece.classList.contains('available-tile')) {
      ...
      piece.addEventListener('click', _listeners_js__WEBPACK_IMPORTED_MODULE_1__.attackFunction);
    }
  });
};
...
/* harmony export */ });
/* harmony import */ var _display_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./display.js */ "./src/dom/display.js");
/* harmony import */ var _factories_game__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../factories/game */ "./src/factories/game.js");
/* harmony import */ var _factories_player_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../factories/player.js */ "./src/factories/player.js");
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  welcomeForm.addEventListener("submit", event => {
    ...
    _controller_js__WEBPACK_IMPORTED_MODULE_3__.orchestrateStartGame();
  });
  attackFunction = event => {
    _controller_js__WEBPACK_IMPORTED_MODULE_3__.orchestrateAttack(event);
  };
  ...
  restartBtn.addEventListener('click', _controller_js__WEBPACK_IMPORTED_MODULE_3__.orchestrateRestartGame);
});
...
"use strict";
var _ships_json__WEBPACK_IMPORTED_MODULE_3___namespace_cache;
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
...
/* harmony import */ var _dom_display_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../dom/display.js */ "./src/dom/display.js");
...
const Game = playerName => {
  ...
  const playerTwo = (0,_player__WEBPACK_IMPORTED_MODULE_0__.Computer)('Computer');
  const playerBoard = (0,_gameboard__WEBPACK_IMPORTED_MODULE_1__.Gameboard)();
  const enemyBoard = (0,_gameboard__WEBPACK_IMPORTED_MODULE_1__.Gameboard)();
  const data = /*#__PURE__*/ (_ships_json__WEBPACK_IMPORTED_MODULE_3___namespace_cache || (_ships_json__WEBPACK_IMPORTED_MODULE_3___namespace_cache = __webpack_require__.t(_ships_json__WEBPACK_IMPORTED_MODULE_3__, 2)));
  ...
  const gameOver = winner => {
    _dom_display_js__WEBPACK_IMPORTED_MODULE_2__.toggleModal();
    _dom_display_js__WEBPACK_IMPORTED_MODULE_2__.addWinnerToModal(winner.name);
  };
  return {
    playerOne,
    playerTwo,
...
/* harmony import */ var _dom_listeners_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../dom/listeners.js */ "./src/dom/listeners.js");



const Gameboard = () => {
  // gameboard tracks all misses or hits
  let gameboard = [[null, null, null, null, null, null, null], [null, null, null, null, null, null, null], [null, null, null, null, null, null, null], [null, null, null, null, null, null, null], [null, null, null, null, null, null, null], [null, null, null, null, null, null, null], [null, null, null, null, null, null, null]];
  const ships = [];
  ...
  const placeShip = (coords, shipType) => {
    ...
    const newShip = (0,_ship_js__WEBPACK_IMPORTED_MODULE_0__.Ship)(shipSize, shipType);
    ships.push({
      ship: newShip,
      coordinates: coords,
      status: 'not sunk'
  ...
  const _attackBoat = coord => {
    ...
    for (const boat of ships) {
      for (const position of boat.coordinates) {
        if (lodash_isEqual__WEBPACK_IMPORTED_MODULE_1___default()(position, coord)) {
          boat.ship.hit();
          const returnValue = {
            status: 'hit',
            boatSunk: false,
            coord: position,
            shipType: boat.ship.type
          };
          if (boat.ship.isSunk()) {
            boat.status = 'sunk';
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body {\n  margin: 0px;\n  min-height: 100vh;\n  font-family: 'IBM Plex Mono', monospace;\n}\n\n.app {\n  align-items: center;\n  padding: 25px;\n  height: 100%;\n  width: 60%;\n\n\n}\n\n.column {\n  flex-direction: column;\n  gap: 30px;\n}\n\n.flex {\n  display: flex;\n  justify-content: center;\n}\n\ninput {\n  padding: 5px;\n  width: 150px;\n  height: 20px;\n  border: 1px solid gray;\n  margin: 0px;\n  border-right: 0px;\n}\n\nbutton {\n  border: 1px solid gray;\n  margin: 0px;\n}\n\nbutton:hover {\n  cursor: pointer;\n}\n\n#board-container {\n  gap: 40px;\n  flex-wrap: wrap;\n}\n\n.board {\n  display: grid;\n  grid-template: repeat(7, 40px) / repeat(7, 40px);\n  gap: 5px;\n  justify-content: center;\n\n}\n\n.board-space {\n\n  border: 1px solid black;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  font-size: 20px;\n}\n\n.available-tile:hover {\n  cursor: pointer;\n  box-shadow: 1px 1px 6px 0px rgb(0 0 0 / 25%);\n}\n\n.missed {\n  background-color: lightblue;\n}\n\n.boat-position,\n.hit {\n  background-color: lightcoral;\n}\n\n.hide {\n  display: none;\n}\n\n.boat-sunk {\n  background-color: red;\n}\n\n#feedback-container {\n  border: 1px solid black;\n  padding: 20px;\n  border-radius: 5px;\n  box-shadow: 1px 1px 6px 0px rgb(0 0 0 / 25%);\n  width: 70%;\n}\n\nh1,\np {\n  margin: 0px;\n}\n\n\n.blinker {\n  animation: blinker 1s linear infinite;\n}\n\n@keyframes blinker {\n  50% {\n    opacity: 0;\n  }\n}\n\n@keyframes blink {\n  0% {\n    opacity: 1;\n  }\n\n  40% {\n    opacity: 1;\n  }\n\n  60% {\n    opacity: 0;\n  }\n\n  100% {\n    opacity: 0;\n  }\n}\n\n.modal {\n  position: fixed;\n  width: 100%;\n  height: 100%;\n  background-color: rgba(0, 0, 0, 0.7);\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  left: 0;\n  top: 0;\n  z-index: 1;\n}\n\n.modal-content {\n  background-color: white;\n  border-radius: 10px;\n  box-shadow: 1px 1px 6px 0px rgb(0 0 0 / 25%);\n  padding: 50px;\n  flex-direction: column;\n  align-items: center;\n  gap: 10px;\n}\n\n.hide {\n  display: none;\n}", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAEA;EACE,WAAW;EACX,iBAAiB;EACjB,uCAAuC;AACzC;;AAEA;EACE,mBAAmB;EACnB,aAAa;EACb,YAAY;EACZ,UAAU;;;AAGZ;;AAEA;EACE,sBAAsB;EACtB,SAAS;AACX;;AAEA;EACE,aAAa;EACb,uBAAuB;AACzB;;AAEA;EACE,YAAY;EACZ,YAAY;EACZ,YAAY;EACZ,sBAAsB;EACtB,WAAW;EACX,iBAAiB;AACnB;;AAEA;EACE,sBAAsB;EACtB,WAAW;AACb;;AAEA;EACE,eAAe;AACjB;;AAEA;EACE,SAAS;EACT,eAAe;AACjB;;AAEA;EACE,aAAa;EACb,gDAAgD;EAChD,QAAQ;EACR,uBAAuB;;AAEzB;;AAEA;;EAEE,uBAAuB;EACvB,aAAa;EACb,uBAAuB;EACvB,mBAAmB;EACnB,eAAe;AACjB;;AAEA;EACE,eAAe;EACf,4CAA4C;AAC9C;;AAEA;EACE,2BAA2B;AAC7B;;AAEA;;EAEE,4BAA4B;AAC9B;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,qBAAqB;AACvB;;AAEA;EACE,uBAAuB;EACvB,aAAa;EACb,kBAAkB;EAClB,4CAA4C;EAC5C,UAAU;AACZ;;AAEA;;EAEE,WAAW;AACb;;;AAGA;EACE,qCAAqC;AACvC;;AAEA;EACE;IACE,UAAU;EACZ;AACF;;AAEA;EACE;IACE,UAAU;EACZ;;EAEA;IACE,UAAU;EACZ;;EAEA;IACE,UAAU;EACZ;;EAEA;IACE,UAAU;EACZ;AACF;;AAEA;EACE,eAAe;EACf,WAAW;EACX,YAAY;EACZ,oCAAoC;EACpC,aAAa;EACb,uBAAuB;EACvB,mBAAmB;EACnB,OAAO;EACP,MAAM;EACN,UAAU;AACZ;;AAEA;EACE,uBAAuB;EACvB,mBAAmB;EACnB,4CAA4C;EAC5C,aAAa;EACb,sBAAsB;EACtB,mBAAmB;EACnB,SAAS;AACX;;AAEA;EACE,aAAa;AACf","sourcesContent":["@import url('https://fonts.googleapis.com/css2?family=IBM+Plex+Mono&display=swap');\n\nbody {\n  margin: 0px;\n  min-height: 100vh;\n  font-family: 'IBM Plex Mono', monospace;\n}\n\n.app {\n  align-items: center;\n  padding: 25px;\n  height: 100%;\n  width: 60%;\n\n\n}\n\n.column {\n  flex-direction: column;\n  gap: 30px;\n}\n\n.flex {\n  display: flex;\n  justify-content: center;\n}\n\ninput {\n  padding: 5px;\n  width: 150px;\n  height: 20px;\n  border: 1px solid gray;\n  margin: 0px;\n  border-right: 0px;\n}\n\nbutton {\n  border: 1px solid gray;\n  margin: 0px;\n}\n\nbutton:hover {\n  cursor: pointer;\n}\n\n#board-container {\n  gap: 40px;\n  flex-wrap: wrap;\n}\n\n.board {\n  display: grid;\n  grid-template: repeat(7, 40px) / repeat(7, 40px);\n  gap: 5px;\n  justify-content: center;\n\n}\n\n.board-space {\n\n  border: 1px solid black;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  font-size: 20px;\n}\n\n.available-tile:hover {\n  cursor: pointer;\n  box-shadow: 1px 1px 6px 0px rgb(0 0 0 / 25%);\n}\n\n.missed {\n  background-color: lightblue;\n}\n\n.boat-position,\n.hit {\n  background-color: lightcoral;\n}\n\n.hide {\n  display: none;\n}\n\n.boat-sunk {\n  background-color: red;\n}\n\n#feedback-container {\n  border: 1px solid black;\n  padding: 20px;\n  border-radius: 5px;\n  box-shadow: 1px 1px 6px 0px rgb(0 0 0 / 25%);\n  width: 70%;\n}\n\nh1,\np {\n  margin: 0px;\n}\n\n\n.blinker {\n  animation: blinker 1s linear infinite;\n}\n\n@keyframes blinker {\n  50% {\n    opacity: 0;\n  }\n}\n\n@keyframes blink {\n  0% {\n    opacity: 1;\n  }\n\n  40% {\n    opacity: 1;\n  }\n\n  60% {\n    opacity: 0;\n  }\n\n  100% {\n    opacity: 0;\n  }\n}\n\n.modal {\n  position: fixed;\n  width: 100%;\n  height: 100%;\n  background-color: rgba(0, 0, 0, 0.7);\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  left: 0;\n  top: 0;\n  z-index: 1;\n}\n\n.modal-content {\n  background-color: white;\n  border-radius: 10px;\n  box-shadow: 1px 1px 6px 0px rgb(0 0 0 / 25%);\n  padding: 50px;\n  flex-direction: column;\n  align-items: center;\n  gap: 10px;\n}\n\n.hide {\n  display: none;\n}"],"sourceRoot":""}]);
// Exports
...
"use strict";
module.exports = JSON.parse('{"boats":[{"name":"carrier","size":5},{"name":"battleship","size":4},{"name":"destroyer","size":3},{"name":"submarine","size":3},{"name":"patrol boat","size":2}]}');
...
/* harmony import */ var _dom_listeners_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dom/listeners.js */ "./src/dom/listeners.js");
